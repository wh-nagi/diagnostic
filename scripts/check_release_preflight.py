...
def publication_state(repository: str, version: str) -> PublicationState:
    ...
    return PublicationState(
        ...
        pypi_version=_resource_exists(
            f"https://pypi.org/pypi/ml4t-diagnostic/{encoded_version}/json"
        ),
    )
...
def source_version() -> str:
    ...
    source = Path("src/ml4t/diagnostic/__init__.py").read_text(encoding="utf-8")
